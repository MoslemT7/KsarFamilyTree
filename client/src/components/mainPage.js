    ...
    <div className="mainPage">
      ...
      <div className="description">
        ...
        <div className="relationship-card">
          <h2>🔍 أداة إيجاد العلاقة العائلية</h2>
          <p>
            هل تساءلت يومًا عن علاقتك بأي شخص في قصر أولاد بوبكر؟ <br />
            الآن يمكنك معرفة العلاقة بدقة، عرض الجد المشترك، شجرة العائلة بينكما، وحتى استخراج شهادة العلاقة!
          </p>
          <ul>
            <li>🌿 نوع العلاقة ووصفها</li>
            <li>🌳 شجرة العائلة بين الشخصين</li>
            <li>📏 مقياس درجة القرابة</li>
          </ul>
          <a href="/relation-checker" className="relationship-button">اكتشف العلاقة الآن</a>
        </div>
